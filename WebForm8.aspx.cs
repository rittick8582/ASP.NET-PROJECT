...
namespace WebApplication1
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        private void ChangeHeaderText()
        {
            ...
            this.DataGrid1.Columns[1].HeaderText = "ISBN";
            this.DataGrid1.Columns[2].HeaderText = "Issue Date";
            this.DataGrid1.Columns[3].HeaderText = "Return Date";
            this.DataGrid1.Columns[4].HeaderText = "Fine";
        }
