...
<body>
    <form id="form1" runat="server">
        <div>
        <center>
            <h2>Show Book Issue and Return Date</h2>
            <table>
                <tr>
                    <td>
                 ...
                 <tr>
                    ...
                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="false" 
                            Font-Bold="True" Font-Italic="True" Width="572px">
    <Columns>
        <asp:BoundColumn DataField="stuid" HeaderText="Student ID" />
        <asp:BoundColumn DataField="isbn" HeaderText="ISBN" />
        <asp:BoundColumn DataField="issdate" HeaderText="Issue Date" />
        <asp:BoundColumn DataField="retdate" HeaderText="Return Date" />
        <asp:BoundColumn DataField="fine" HeaderText="Fine" />
    </Columns>
</asp:DataGrid>
                    </td>
                    </tr>
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Search" Width="190px" 
                            onclick="Button1_Click" />
                        <asp:Button ID="Button2" runat="server" Text="Close" Width="194px" 
                            BackColor="Red" onclick="Button2_Click" />
                        <asp:Button ID="Button3" runat="server" Text="Refresh" Width="194px" 
