    ...
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="Fullname" Font-Bold="True" ForeColor="#990000"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Search" Width="190px" onclick="Button1_Click" 
                            />
                            <asp:Button ID="Button4" runat="server" Text="Update" Width="194px" onclick="Button4_Click" 
                            /><br />
