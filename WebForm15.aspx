...
<head id="Head1" runat="server">
    <title>Update Issue Book Details</title>
    <style>
        body {
    ...
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="ISBN" Font-Bold="True" ForeColor="#990000"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Issue Date" Font-Bold="True" ForeColor="#990000"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Return Date" Font-Bold="True" ForeColor="#990000"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label5" runat="server" Text="Fine" Font-Bold="True" ForeColor="#990000"></asp:Label>
                        <asp:TextBox ID="TextBox5" runat="server" BackColor="Transparent" 
                            BorderColor="#990000" Font-Size="Medium" Font-Bold="True" 
                            Font-Italic="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Search" Width="154px" onclick="Button1_Click" 
                             />
                        <asp:Button ID="Button2" runat="server" Text="Update" Width="157px" onclick="Button2_Click" 
                               />
                         <asp:Button ID="Button4" runat="server" Text="Calculate" Width="150px" onclick="Button4_Click"  
                               />
                         <asp:Button ID="Button3" runat="server" Text="Close" Width="166px" 
                            BackColor="Red" onclick="Button3_Click"
                               />
                    </td>
                </tr>
            </table>
