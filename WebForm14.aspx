...
<head id="Head1" runat="server">
    <title>Insert Issue Book Details</title>
    <style>
        body {
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="TextBox3" runat="server" BackColor="Transparent" BorderColor="#990000" Font-Size="Medium" Font-Bold="True" Font-Italic="True" TextMode="Date"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Return Date" Font-Bold="True" ForeColor="#990000"></asp:Label>
                        <asp:TextBox ID="TextBox4" runat="server" BackColor="Transparent" BorderColor="#990000" Font-Size="Medium" Font-Bold="True" Font-Italic="True" TextMode="Date"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
